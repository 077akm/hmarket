...
<div id="pcoded" class="pcoded">
    ...
    <div class="pcoded-container navbar-wrapper">
        <nav class="navbar header-navbar pcoded-header" @if(Auth::user()->role_id==3)style="background-color: darkblue"@endif>
                ...
                <nav class="pcoded-navbar">
                    ...
                    <div class="pcoded-inner-navbar main-menu">
                            ...
                            <div class="main-menu-content">
                                <ul>
                                    <li class="more-details">
                                        <a href="{{url('/documents')}}"><i class="ti-settings"></i>Settings</a>
                        ...
                        <ul class="pcoded-item pcoded-left-item">
                            <li class="active" >
                                <a href="" class="waves-effect waves-dark" @if(Auth::user()->role_id==3)style="background-color: darkblue"@endif>
                            ...
                            <li>
                                ...
                                <a href="{{route('adm.users.index')}}" class="waves-effect waves-dark">
                                    ...
                                    <span class="pcoded-mtext"  data-i18n="nav.basic-components.main">Клиенты Сайта</span>
                                    <span class="pcoded-mcaret"></span>
                                </a>
                        ...
                        <ul class="pcoded-item pcoded-left-item">
                            @if(Auth::user()->role_id == 3)
                                <li>
                                    <a href="{{route('adm.documents')}}" class="waves-effect waves-dark">
                                        <span class="pcoded-micon"><i class="ti-layers"></i><b>FC</b></span>
                                        <span class="pcoded-mtext" data-i18n="nav.form-components.main">Документы</span>
                                        <span class="pcoded-mcaret"></span>
                                    </a>
                                </li>
                                ...
                                <li>
                                    <a href="{{route('adm.cart.index')}}" class="waves-effect waves-dark">
                                        <span class="pcoded-micon"><i class="ti-layout-grid2-alt"></i></span>
                                        <span class="pcoded-mtext"  data-i18n="nav.basic-components.main">Заявки и Сообщение</span>
                                        <span class="pcoded-mcaret"></span>
                                    </a>

                                </li>
                                <li>
                                    <a href="{{route('adm.botchat')}}" class="waves-effect waves-dark">
                                        <span class="pcoded-micon"><i class="ti-layout-grid2-alt"></i></span>
                                        <span class="pcoded-mtext"  data-i18n="nav.basic-components.main">Сообщении БОТА</span>
                                        <span class="pcoded-mcaret"></span>
                                    </a>
