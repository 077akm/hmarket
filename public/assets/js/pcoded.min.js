    ...
    var PcodedMenu = {
            ...
            if (settings.themelayout === "vertical") {
                switch (settings.collapseVerticalLeftHeader) {
                    case true:
                        ...
                        /*  $('#'+oid + ' .pcoded-header.nocollapsed .pcoded-left-header').css.css('width', '');  */
                        break;
                    case false:
                        ...
                        /*  $('#'+oid + ' .pcoded-header.nocollapsed .pcoded-left-header').css.css('width', $(".pcoded-navbar").width());  */
                        break;
                    default:
                }
            } else {
        ...
        Handlecomponetheight: function() {
            function setHeight() {
                ...
                var lpanelH = WH - HH;
                // if (settings.themelayout === "horizontal" ) {
                // 	$(".pcoded-navbar").css.css('height', contentHH);
                // } else if (settings.themelayout === "vertical" ) {
                // 	if ( contentVH >= lpanelH ){
                // 		$(".pcoded-navbar").css.css('height', contentVH);
                // 	}else {
                // 		$(".pcoded-navbar").css.css('height', lpanelH);
                // 	}
                // } else {
                // 	return false;
                // }
